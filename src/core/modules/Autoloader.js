...
var _load = function(loadPath, loadExport, app, verbose) {
    ...
    _log(('Loading ' + loadExport + '-exports from path ' + loadPath + '...').yellow, verbose);
    ...
    _log(('[' + loaded + '] ' + loadExport + '-exports loaded').green, verbose);
    if (failed) {
        _log(('[' + failed + '] ' + loadExport + '-exports failed').yellow, verbose);
    }
    if (inactive) {
        _log(('[' + inactive + '] ' + loadExport + '-exports inactive').gray, verbose);
    }
}
